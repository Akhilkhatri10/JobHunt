    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className="max-w-7xl mx-auto my-6">
                <button
                    onClick={() => navigate(-1)}
                    className="flex items-center py-1 px-3 text-gray-700 border border-gray-400 rounded-md hover:text-black font-semibold text-lg shadow-md hover:shadow-lg transition-all duration-200"
                >
                    ← Back
                </button>
            </div>
            ...
            <h1 className='border-b-2 border-b-gray-300 font-medium pt-6 pb-3'>Job Description</h1>
            <div className='my-2'>
